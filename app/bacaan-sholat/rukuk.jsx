...
export default function Rukuk() {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Rukuk</Text>

      <Text style={styles.arab}>سُبْحَانَ رَبِّيَ الْعَظِيمِ وَبِحَمْدِهِ</Text>
      <Text style={styles.latin}>Subhaana rabbiyal ‘adziimi wa bihamdih.</Text>
      <Text style={styles.arti}>Maha Suci Tuhanku Yang Maha Agung dan segala puji bagi-Nya.</Text>
    </ScrollView>
  );
}
